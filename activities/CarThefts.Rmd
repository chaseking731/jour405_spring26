...
It is close to a normal distribution as the mode is close to the mean and the bunch of the data is bunched up within the standard deviation. To assign a precentage to it, I would say its 67% or two-thirds normal. The data falls between 20 and 3 and around 24 of the 31 days fall within the standard deviation ~8-~17.
