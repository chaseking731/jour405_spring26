...
We found that UMD is continuing to add student fees, sometimes doubling fees with unknown uses. 
I think the story is that we are unaware of what they are doing with the money of the fees, 
specifically the Student Sustainability fee that doesn't seem to have an obvious use.
