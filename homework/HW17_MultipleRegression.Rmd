...
It looks like the percent of the population with a bachelors degree or higher has a high correlation with the voter turn out. A higher average income led to a higher voter turn out rate. It also feels like the older the average age was the higher the turnout was. Population does not have that much of a relationship with voter turn out. 
...
This model is very useful based off the R-squared, the coefficients and p-value. The residual standard error is 0.02174. 
...
None of the models see significant improvements, but model 2, which is all of the variables besides population did improve on the full model and had the highest possible R-squared. Population seemed to be the least important variable, with percent of unemployment being the second less important as it had similar results to income. 
...
I would say explain what the data told me in terms of expected outcome in each specific region. I would say something like 'using data from Prince George's County, it is expected to see a voter turnout of XXX,XXX." I think that I could also add some more explanation of the data used in the model later in the story, but I think for the beginning of the article that giving them the numbers would be most useful.